     ...
     <Center w="100%" pt={15} pb={10}>
      ...
      <Box bg={CardBg} borderRadius="lg" mt={8} p={8} position="relative">
        ...
        <Text fontWeight="bold" pb={4} letterSpacing="0.1rem">
          ...
          <Text fontWeight="bold" color={HighlightText}>June 2023 - March 2024 </Text>
       ...
       <Box bg={CardBg} borderRadius="lg" mt={8} p={8} position="relative">
        ...
        <Text fontWeight="bold" pb={4} letterSpacing="0.1rem">
          ...
          <Text fontWeight="bold" color={HighlightText}>October 2022 - May 2023 </Text>
            <Text fontWeight="bold" color={CardText}>Full-time | Remote</Text>
      ...
      <Box bg={CardBg} borderRadius="lg" mt={8} p={8} position="relative">
        ...
        <Text fontWeight="bold" pb={4} letterSpacing="0.1rem">
          ...
          <Text fontWeight="bold" color={HighlightText}>January 2022 - September 2022</Text>
